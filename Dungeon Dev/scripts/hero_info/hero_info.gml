...
function sc_info_hero_bow()
{
	...
	ind_range_s		= s_bow01_hit;
	ind_range_spd	= 5;
}

function sc_info_hero_bow_red()
{
	ind_atk_sc		= sc_atk_range_5f_3;
	ind_death_sc	= sc_death_4f;
	ind_atk_range	= 115;
	...
	ind_spr_stand	= spr_h_bow_red_stand;
	ind_spr_walk	= spr_h_bow_red_walk;
	ind_spr_atk		= spr_h_bow_red_atk;
	ind_spr_death	= spr_h_bow_red_death;
