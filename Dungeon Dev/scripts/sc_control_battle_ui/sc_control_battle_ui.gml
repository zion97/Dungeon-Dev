...
function sc_control_battle_ui()
{
	...
	draw_sprite_ext(spr_deploy_button_space2, sc_is_same(3, ind_button_num), _port_w/2 + 747, _port_h-84, 3, 3, 0, c_white, 1);
	...
	if (ind_hero_num > 0)
	{
		for (var _i = 0; _i < ind_hero_num; _i++)
		{
			...
			//	3, 3, 0, c_white, 1);
			draw_sprite_ext(spr_hero_battle_ui, _in, _ind_x + 180 + _i*200, _port_h-115, 
				3, 3, 0, c_white, 1);
			//draw_sprite_part_ext(_spr, _img, 18, 21, 108, 102, 
			//	_ind_x + 180 + _i*200 - 54, _port_h-115-40 - 51,  6, 6, c_white, 1);
			draw_sprite_ext(_spr, _img, _ind_x + 180 + _i*200, _port_h-115-56, 
				6, 6, 0, c_white, 1);
			...
			if (_l > 0)
			{
				...
				draw_rectangle(_ind_x + 180 + _i*200 - 54, _port_h-115 + 18, 
					_ind_x + 180 + _i*200 - 54 + (107*_l), _port_h-115 + 29, false);
			}
			...
			if (_l > 0)
			{
				...
				if (_l >= 1)	{ _l = 1;	draw_set_color(c_yellow); }
				draw_rectangle(_ind_x + 180 + _i*200 - 54, _port_h-115 + 48, 
					_ind_x + 180 + _i*200 - 54 + (107*_l), _port_h-115 + 59, false);
			}
